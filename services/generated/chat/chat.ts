...
export function useChatControllerGetConversationsInfinite<TData = InfiniteData<Awaited<ReturnType<typeof chatControllerGetConversations>>, ChatControllerGetConversationsParams['cursor']>, TError = unknown>(
 params: undefined |  ChatControllerGetConversationsParams, options: { query:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof chatControllerGetConversations>>, TError, TData, QueryKey, ChatControllerGetConversationsParams['cursor']>> & Pick<
        DefinedInitialDataOptions<
...
export const getChatControllerGetConversationMessagesInfiniteQueryKey = (conversationId: string,
    params?: ChatControllerGetConversationMessagesParams,) => {
    return [
    'infinite', `/chats/conversations/${conversationId}/messages`, ...(params ? [params] : [])
    ] as const;
    }
...
export const getChatControllerGetConversationMessagesInfiniteQueryOptions = <TData = InfiniteData<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, ChatControllerGetConversationMessagesParams['cursor']>, TError = unknown>(conversationId: string,
    params?: ChatControllerGetConversationMessagesParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, TError, TData, QueryKey, ChatControllerGetConversationMessagesParams['cursor']>>, }
) => {
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getChatControllerGetConversationMessagesInfiniteQueryKey(conversationId,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, QueryKey, ChatControllerGetConversationMessagesParams['cursor']> = ({ signal, pageParam }) => chatControllerGetConversationMessages(conversationId,{...params, 'cursor': pageParam ?? params?.['cursor']}, signal);





   return  { queryKey, queryFn, enabled: conversationId !== null && conversationId !== undefined, ...queryOptions} as UseInfiniteQueryOptions<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, TError, TData, QueryKey, ChatControllerGetConversationMessagesParams['cursor']> & { queryKey: DataTag<QueryKey, TData, TError> }
}

export type ChatControllerGetConversationMessagesInfiniteQueryResult = NonNullable<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>>
export type ChatControllerGetConversationMessagesInfiniteQueryError = unknown


export function useChatControllerGetConversationMessagesInfinite<TData = InfiniteData<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, ChatControllerGetConversationMessagesParams['cursor']>, TError = unknown>(
 conversationId: string,
    params: undefined |  ChatControllerGetConversationMessagesParams, options: { query:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, TError, TData, QueryKey, ChatControllerGetConversationMessagesParams['cursor']>> & Pick<
        DefinedInitialDataOptions<
          Awaited<ReturnType<typeof chatControllerGetConversationMessages>>,
          TError,
          Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, QueryKey
        > , 'initialData'
      >, }
 , queryClient?: QueryClient
  ):  DefinedUseInfiniteQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
export function useChatControllerGetConversationMessagesInfinite<TData = InfiniteData<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, ChatControllerGetConversationMessagesParams['cursor']>, TError = unknown>(
 conversationId: string,
    params?: ChatControllerGetConversationMessagesParams, options?: { query?:Partial<UseInfiniteQueryOptions<Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, TError, TData, QueryKey, ChatControllerGetConversationMessagesParams['cursor']>> & Pick<
        UndefinedInitialDataOptions<
          Awaited<ReturnType<typeof chatControllerGetConversationMessages>>,
          TError,
          Awaited<ReturnType<typeof chatControllerGetConversationMessages>>, QueryKey
