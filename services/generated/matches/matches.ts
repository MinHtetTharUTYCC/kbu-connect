...
export const getMatchesControllerGetMatchesQueryKey = (
  params?: MatchesControllerGetMatchesParams,
) => {
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getMatchesControllerGetMatchesQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof matchesControllerGetMatches>>
  > = ({ signal }) => matchesControllerGetMatches(params, signal);
...
export type MatchesControllerGetMatchesQueryResult = NonNullable<
  Awaited<ReturnType<typeof matchesControllerGetMatches>>
>;
export type MatchesControllerGetMatchesQueryError = unknown;

export function useMatchesControllerGetMatches<
  TData = Awaited<ReturnType<typeof matchesControllerGetMatches>>,
  TError = unknown,
>(
...
>(
  ...
  const queryOptions = getMatchesControllerGetMatchesQueryOptions(
    params,
    options,
  );
...
export const getMatchesControllerMarkMatchAsSeenMutationOptions = <
  TError = unknown,
  TContext = unknown,
>(options?: {
...
export type MatchesControllerMarkMatchAsSeenMutationResult = NonNullable<
  Awaited<ReturnType<typeof matchesControllerMarkMatchAsSeen>>
>;
 ...
 * @summary Mark a match as seen
 */
export const useMatchesControllerMarkMatchAsSeen = <
  TError = unknown,
  TContext = unknown,
>(
  options?: {
...
> => {
  return useMutation(
    getMatchesControllerMarkMatchAsSeenMutationOptions(options),
    queryClient,
  );
};
/**
...
export const getMatchesControllerUnmatchMutationOptions = <
  TError = void,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type MatchesControllerUnmatchMutationResult = NonNullable<
  Awaited<ReturnType<typeof matchesControllerUnmatch>>
>;
...
> => {
  return useMutation(
    getMatchesControllerUnmatchMutationOptions(options),
    queryClient,
  );
};
