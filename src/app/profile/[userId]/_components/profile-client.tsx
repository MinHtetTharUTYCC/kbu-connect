...
function ProfileMetaChip({ item }: { item: ProfileMetaItem }) {
    ...
    return (
        <span className="inline-flex max-w-full items-center gap-1.5 rounded-full border border-black/10 bg-muted px-2.5 py-1 text-xs font-medium text-foreground">
