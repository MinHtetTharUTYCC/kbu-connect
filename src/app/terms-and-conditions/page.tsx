        ...
        <main className="mx-auto flex min-h-svh w-full max-w-[430px] flex-col bg-white px-5 pb-10 text-foreground">
            ...
            <section className="my-8">
                ...
                <p className="text-sm leading-[1.75]">
                    By accessing or using KBU Connect, you agree to be bound by
                    these Terms and Conditions. If you do not agree to these
                    terms, please do not use the platform. KBU Connect is
                    exclusively available to current students of Kasem Bundit
                    University with a valid{' '}
                    <code className="rounded border border-border bg-muted px-1.5 py-px font-mono text-[12px]">
                        @ms.kbu.ac.th
                    </code>{' '}
                    email address.
                </p>
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    You must be a current student at Kasem Bundit University to
                    use KBU Connect. By creating an account, you represent and
                    warrant that you meet this eligibility requirement and that
            ...
            <section className="mb-8">
                ...
                <div className="space-y-3">
                    <p className="text-sm leading-[1.75]">
                        You agree to use KBU Connect only for lawful purposes
                    ...
                    <p className="text-sm leading-[1.75]">
                        Post or transmit content that is harmful, threatening,
                        abusive, harassing, defamatory, or otherwise
                        objectionable.
                    </p>
                    <p className="text-sm leading-[1.75]">
                        Attempt to gain unauthorized access to other user
                        accounts or the platform systems.
                    </p>
                    <p className="text-sm leading-[1.75]">
                        Use automated tools or bots to interact with the
                        platform.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    All content, features, and functionality of KBU Connect are
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    KBU Connect is provided &quot;as is&quot; without warranties
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75] ">
                    ...
                    use of the platform after any changes constitutes acceptance
                    of the new Terms.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    ...
                    please contact us through the KBU Connect platform.
                </p>
            </section>
