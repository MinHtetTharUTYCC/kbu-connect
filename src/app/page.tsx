...
const HOW_IT_WORKS = [
    ...
    },
    {
        ...
        title: 'Match',
        description:
            'Swipe right to like someone. If they like you back, it is a match.',
    },
    {
        icon: MessageCircle,
        title: 'Chat',
            ...
            <main className="mx-auto flex min-h-svh w-full max-w-[430px] flex-col overflow-y-auto bg-background px-5 pb-10 text-foreground">
                ...
                <div className="mb-8 flex flex-col gap-3">
                    ...
                    <div className="flex items-center justify-center gap-1.5 text-[12px] text-muted-foreground">
                        ...
                        100% EDU-Mail Verified Environment
                    </div>
                </div>
                ...
                <section className="mb-8">
                    ...
                    <p className="text-sm leading-[1.75] text-muted-foreground">
                        KBU Connect is a dating and social discovery platform
                        built exclusively for Kasem Bundit University students.
                        Swipe through profiles, match with people you are
                        interested in, and start a conversation.
                    </p>
                </section>
