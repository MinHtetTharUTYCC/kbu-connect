...
import { Chip, EmptyState, MobileScreen, TopBar } from '@/components/mobile/app-chrome';
    ...
    if (isLoading) {
        return (
            <MobileScreen className="h-full min-h-0">
                <TopBar />
                <EmptyState title="Loading profiles" body="Finding people you may want to meet." />
            </MobileScreen>
        );
    }
                        ...
                        <div className="space-y-3 p-4">
                            <div className="flex items-end gap-2">
                                ...
                                <span className="pb-0.5 text-sm text-[#6b6b6b]">
                                    {profile?.nationality ? profile.nationality.slice(0, 2) : 'KBU'}
                                </span>
                            </div>
