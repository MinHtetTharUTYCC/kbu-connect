...
import { Avatar, Chip, EmptyState, MobileScreen, TopBar } from '@/components/mobile/app-chrome';
    ...
    if (conversationsLoading) {
        return (
            <MobileScreen>
                ...
                <EmptyState title="Loading conversation" body="Opening your conversation." />
            </MobileScreen>
        );
    }
