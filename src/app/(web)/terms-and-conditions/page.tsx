...
export const metadata: Metadata = {
    ...
    description:
        'Terms and Conditions for KBU Connect, a dating and social discovery platform for Kasem Bundit University students.',
    openGraph: {
        title: 'Terms and Conditions - KBU Connect',
        description:
            'Terms and Conditions for KBU Connect, a dating and social discovery platform for Kasem Bundit University students.',
        ...
        <main className="mx-auto flex min-h-svh w-full max-w-[430px] flex-col bg-white px-5 pb-10 text-[#1c1b1b]">
            ...
            <section className="my-8">
                ...
                <p className="text-sm leading-[1.75]">
                    By accessing or using KBU Connect, you agree to be bound by these Terms and
                    Conditions. If you do not agree to these terms, please do not use the platform.
                    KBU Connect is exclusively available to current students of Kasem Bundit
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    You must be a current student at Kasem Bundit University to use KBU Connect. By
                    creating an account, you represent and warrant that you meet this eligibility
                    requirement and that all information you provide is accurate and truthful.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <div className="space-y-3">
                    <p className="text-sm leading-[1.75]">
                        You agree to use KBU Connect only for lawful purposes and in accordance with
                    ...
                    <p className="text-sm leading-[1.75]">
                        Post or transmit content that is harmful, threatening, abusive, harassing,
                        defamatory, or otherwise objectionable.
                    </p>
                    <p className="text-sm leading-[1.75]">
                        Attempt to gain unauthorized access to other user accounts or the platform
                        systems.
                    </p>
                    <p className="text-sm leading-[1.75]">
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    ...
                    all activities that occur under your account. You agree to immediately notify us
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    All content, features, and functionality of KBU Connect are owned by us and are
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    KBU Connect is provided &quot;as is&quot; without warranties of any kind. We
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75] ">
                    ...
                    any changes by posting the new Terms on this page and updating the effective
                    date. Your continued use of the platform after any changes constitutes
            ...
            <section className="mb-8">
                ...
                <p className="text-sm leading-[1.75]">
                    ...
                    through the KBU Connect platform.
                </p>
            </section>
