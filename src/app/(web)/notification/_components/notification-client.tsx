...
import { EmptyState, MobileScreen, TopBar } from '@/components/mobile/app-chrome';
...
import { NotificationItemDto, NotificationItemDtoType } from '../../../../../services/model';
        ...
        >
            <div className="flex gap-4 px-5 py-4">
                ...
                <div className="min-w-0 flex-1">
                    ...
                    {notification.body && (
                        <p className="text-sm leading-6 text-[#434655]">{notification.body}</p>
                    )}
                </div>
            </div>
        </div>
